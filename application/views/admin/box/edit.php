<ol class="breadcrumb" >
	<li>
		<a href="<?php echo base_url('box'); ?>"><i class="fa-home"></i>Box</a>
	</li>
	<li class="active">
		<a href="#">Edit Box</a>
	</li>
...
<?php if($this->session->flashdata('errorhapus')!=""){
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<div class="panel-title"><i class="entypo-mail"></i><strong>Edit Box</strong></div>
		</div>
		<form action="<?php echo site_url('Box/update_proses/'.$cekid['id_box']); ?>" method="post">
			<div class="panel-body">
				<div class="row">
					<div class="col-md-2">
						<label class="label-control"><strong>ID Box</strong></label>
					</div>
					<div class="col-md-8">
						<input type="text" required disabled class="form-control" autocomplete="off" name="id_box" value="<?php echo $cekid['id_box'];?>" />
					</div>
				</div>
				<br>
				<div class="row">
					<div class="col-md-2">
						<label class="label-control"><strong>Nama Box</strong></label>
					</div>
					<div class="col-md-8">
						<input type="text" required class="form-control" autocomplete="off" name="nama_box" value="<?php echo $cekid['nama_box'];?>" />
					</div>
				</div>
			</div>
